...
> **Rune = 62 skills × 200+ bidirectional connections × cross-session memory × multi-platform compiler**
...
### Mesh Health
- **Connection density** ≥ 3.0 connections/skill (currently: 3.4 at 200+ connections / 62 skills) — do not let this drop below 2.5
