...
- **Rune version:** <!-- output of `rune --version` or `npx @rune-kit/rune --version` -->
- **Platform:** <!-- Claude Code / Cursor / Windsurf / Antigravity / Codex / OpenCode -->
